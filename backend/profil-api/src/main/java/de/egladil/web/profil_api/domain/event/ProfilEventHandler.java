...
import de.egladil.web.profil_api.domain.exceptions.PropagationFailedException;
import de.egladil.web.profil_api.infrastructure.persistence.dao.EventDao;
import de.egladil.web.profil_api.infrastructure.persistence.entities.StoredEvent;
import de.egladil.web.profil_api.infrastructure.restclient.MkGatewayRestClient;
...
public class ProfilEventHandler {
	...
	public void handleEvent(@Observes final ProfilEvent event) {
		...
		try {
			...
			this.eventRepository.insertEvent(storedEvent);
