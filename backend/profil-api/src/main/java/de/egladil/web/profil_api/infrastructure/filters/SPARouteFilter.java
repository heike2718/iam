...
// (c) Heike Winkelvoß
// =====================================================
package de.egladil.web.profil_api.infrastructure.filters;
...
public class SPARouteFilter {
	...
	private static final String DEFAULT_APP = "/profil-app/";
		...
		if (path.startsWith(APP_PLUS_API_PREFIX)) {
			...
			if (this.doesNotNeedRedirect(path)) {
				...
				if (path.startsWith(DEFAULT_APP)) {
					...
					// I0094: deep-Angular-Router-Links (z.B. /profil-app/user/) müssen zur SPA Grund-URL
					// (/profil-app/) umgeleitet werden. Danach übernimmt wieder das Angular-Routing
