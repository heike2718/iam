...
/**
 * UsersSortColumn mapped Frontend-Labelnamen auf column-names in der View
 * VW_USERS_SUCHE.
 */
public enum UsersSortColumn {

    EMAIL("email"), DATE_MODIFIED_STRING("aenderungsdatum"), NACHNAME("nachname"), VORNAME("vorname");
    ...
    public static UsersSortColumn valueOfLabel(final String label) {
        ...
        Optional<UsersSortColumn> opt = Arrays
                .stream(values())
