...
import de.egladil.web.bv_admin.domain.infomails.InfomailvorlagenService;
...
public class InfomailsResource {
    ...
    @APIResponse(
            ...
            responseCode = "500",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = MessagePayload.class)))
    public Response infomailAendern(
            @Pattern(regexp = "^[abcdef\\d\\-]*$") @Size(max = 36) @PathParam(value = "uuid") final String uuid,
            @Valid final InfomailRequestDto infomailRequestDto) {
