...
public class MailService {
     ...
     * @param body
     * @param empfaenger
     * @throws MailversandException - alle Exceptions die hier gefangen werden,
     *                              werden in eine MailversandException gewrapped.
     */
    public void sendeMail(final AuthAdminMailDto mailDto) throws MailversandException {
        ...
        // LOGGER.info("Sende Mails BCC an {}",
        // StringUtils.join(mailDto.getBccEmpfaenger()));
        ...
        try {
            ...
            Mail mail = Mail
                    .withText(StringUtils.split(standardempfaenger, ",")[0], betreff, body)
    ...
    private String getMailbodySpammailhinweis() {
        ...
        try (InputStream in = getClass().getResourceAsStream("/mails/mailsuffix.txt");
    ...
    public void sendATestMail(final String empfaenger) {
        ...
        try {
            ...
            if (StringUtils.isBlank(empfaenger)) {
                ...
                mailer
                        .send(Mail
                                .withText(empfaengers[0], "Testmail", "This is a simple email from quarkus")
                                .addBcc(empfaengers));
            } else {
