...
public class MailversandauftragDetails {
    ...
    @JsonProperty
    @Schema(
            description = "wie üblich formatiertes Datum mit Uhrzeit, wann der Auftrag erfasst wurde",
            example = "09.07.2024 18:44:13")
    private String erfasstAm;

    @JsonProperty
    @Schema(
            description = "wie üblich formatiertes Datum mit Uhrzeit, wann der Versand begonnen hat",
            example = "09.07.2024 19:01:43")
    private String versandBegonnenAm;

    @JsonProperty
    @Schema(
            description = "wie üblich formatiertes Datum mit Uhrzeit, wann der Versand beendet wurde",
    ...
    @JsonProperty
    @Schema(
            description = "Die Gruppen von Mailempfängern, an die die Mail jeweils als Sammelmail versendet wird / wurde")
