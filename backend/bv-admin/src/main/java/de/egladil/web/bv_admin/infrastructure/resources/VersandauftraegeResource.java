...
import de.egladil.web.bv_admin.domain.mailversand.api.MailversandauftragDetailsResponseDto;
import de.egladil.web.bv_admin.domain.mailversand.api.MailversandauftragOverview;
import de.egladil.web.bv_admin.domain.mailversand.api.MailversandauftragRequestDto;
import de.egladil.web.bv_admin.domain.mailversand.api.MailversandgruppeDetails;
import de.egladil.web.bv_admin.domain.mailversand.api.MailversandgruppeDetailsResponseDto;
import de.egladil.web.bv_admin.domain.mailversand.api.SingleUuidDto;
import de.egladil.web.bv_admin.domain.mailversand.api.VersandauftragService;
...
public class VersandauftraegeResource {
    ...
    @APIResponse(
            ...
            responseCode = "500",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = MessagePayload.class)))
    public Response getDetailsVersandauftrag(@Pattern(regexp = "^[abcdef\\d\\-]*$") @Size(max = 36)
    @PathParam(value = "uuid") @Pattern(regexp = "^[abcdef\\d\\-]*$", message = "uuid enthält ungültige Zeichen")
    @Size(max = 36, message = "uuid zu lang (max. 36 Zeichen)") final String uuid) {

        MailversandauftragDetailsResponseDto responsePayload = versandauftragService
                .detailsMailversandauftragLaden(uuid);
    ...
    @APIResponse(
            ...
            responseCode = "500",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = MessagePayload.class)))
    public Response getDetailsMailversandgruppe(@Pattern(regexp = "^[abcdef\\d\\-]*$") @Size(max = 36)
    @PathParam(value = "uuid") @Pattern(regexp = "^[abcdef\\d\\-]*$", message = "uuid enthält ungültige Zeichen")
    @Size(max = 36, message = "uuid zu lang (max. 36 Zeichen)") final String uuid) {
    ...
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = SingleUuidDto.class)))
    @APIResponse(
            name = "BadRequest",
            responseCode = "400",
            content = @Content(
    ...
    @APIResponse(
            ...
            responseCode = "500",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = MessagePayload.class)))
    public Response versandauftragLoeschen(@Pattern(regexp = "^[abcdef\\d\\-]*$") @Size(max = 36)
    @PathParam(value = "uuid") @Pattern(regexp = "^[abcdef\\d\\-]*$", message = "uuid enthält ungültige Zeichen")
    @Size(max = 36, message = "uuid zu lang (max. 36 Zeichen)") final String uuid) {
    ...
    @APIResponse(
            ...
            responseCode = "500",
            content = @Content(mediaType = "application/json", schema = @Schema(implementation = MessagePayload.class)))
    public Response versandgruppeAendern(
            @PathParam(value = "uuidAuftrag")
            @Pattern(regexp = "^[abcdef\\d\\-]*$", message = "uuidAuftrag enthält ungültige Zeichen")
            @Size(max = 36, message = "uuidAuftrag zu lang (max. 36 Zeichen)") final String uuidAuftrag,
            @PathParam(value = "uuid")
            @Pattern(regexp = "^[abcdef\\d\\-]*$", message = "uuid enthält ungültige Zeichen")
            @Size(max = 36, message = "uuid zu lang (max. 36 Zeichen)") final String uuidGruppe,
            @Valid final MailversandgruppeDetails gruppe) {
