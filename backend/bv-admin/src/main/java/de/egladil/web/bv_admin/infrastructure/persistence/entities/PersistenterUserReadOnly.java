...
@NamedQueries({
        ...
        @NamedQuery(
                name = PersistenterUserReadOnly.FIND_BY_UUID_LIST,
                query = "select u from PersistenterUserReadOnly u where u.uuid in :uuids"),
        @NamedQuery(
                name = PersistenterUserReadOnly.FIND_FOR_MAILVERSAND_BY_UUID_LIST,
                query = "select u from PersistenterUserReadOnly u where u.aktiviert = :aktiviert and u.bannedForMails = :bannedForMails and u.uuid in :uuids"), })
