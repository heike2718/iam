...
public class BVAdminSQLExceptionHelper {
     ...
     *
     * @param th
     * @param errorMessage String das, was in der Message der
     *                     BVAdminAPIRuntimeException stehen soll, wenn keine
     *                     ConstraintViolationException gefunden werden konnte.
     * @return ConstraintViolationException
     * @throws BVAdminAPIRuntimeException
     */
    public static ConstraintViolationException unwrappConstraintViolationException(final Throwable th,
            final String errorMessage) throws BVAdminAPIRuntimeException {
