...
public class BenutzerTrefferlisteItem {
    ...
    @JsonProperty
    @Schema(
            description = "Flag, das anzeigt, ob dieser User über bv-admin gelöscht werden darf, um versehentliches Löschen der ADMINs zu verhindern")
