...
public class MailversandDao {
    ...
    /**
     * Läd alle aktivierten PersistenterUserReadOnly mit den gegebenen UUIDs, deren
     * Mailadresse nicht gebannt ist.
     *
    ...
    public List<PersistenterUserReadOnly> findActivatedAndNotBannedUsersByUUIDs(final List<String> uuids) {
        ...
        return entityManager
                .createNamedQuery(PersistenterUserReadOnly.FIND_FOR_MAILVERSAND_BY_UUID_LIST,
                        PersistenterUserReadOnly.class)
                .setParameter("aktiviert", true)
                .setParameter("bannedForMails", false)
    ...
    public List<PersistenterMailversandauftragReadOnly> loadAllMailversandauftraege() {
        ...
        return entityManager
                .createNamedQuery(PersistenterMailversandauftragReadOnly.LOAD_ALL,
    ...
    /**
     * Gibt von allen noch nicht beendeten Mailversandaufträgen den mit dem
     * frühesten Einstelldatum zurück.
     *
    ...
    public PersistenterMailversandauftrag findOldestNotCompletedMailversandauftrag() {
        ...
        List<PersistenterMailversandauftrag> trefferliste = entityManager
                .createNamedQuery(PersistenterMailversandauftrag.FIND_NOT_COMPLETED,
                        PersistenterMailversandauftrag.class)
    ...
    public List<PersistenteMailversandgruppe> findAllMailversandgruppenWithVersandauftragUUID(
            final String idVersandauftrag) {

        return entityManager
                .createNamedQuery(PersistenteMailversandgruppe.FIND_BY_VERSANDAUFTAG,
                        PersistenteMailversandgruppe.class)
                .setParameter("idVersandauftrag", idVersandauftrag)
                .getResultList();
    }
