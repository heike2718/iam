...
public class InfomailsResourceTest {
    ...
    void testInsert() {
        ...
        requestPayload
                .setMailtext(
                        "Dies ist der Text einer ersten Testmail, damit man in der GUI auch eine Treffermenge angezeigt bekommt");
    ...
    void testLoadInfomailTexte() {
        ...
        Optional<InfomailResponseDto> opt = Arrays
                .stream(responsePayload)
