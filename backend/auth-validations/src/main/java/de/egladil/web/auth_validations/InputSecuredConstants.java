...
public interface InputSecuredConstants {
    ...
    String DIACRITICS = A + B + C + D + E + F + G + H + I + J + K + L + M + N + O + P + R + S + T + TH + U + W + X + Y1
            + Y2 + Z;
     ...
     * Leerzeichen, Minus, Unterstrich, Punkt, Komma, Apostrophe, Leerzeichen, aber
     * keine Zeilenumbrüche! Keine aufeinanderfolgenden Punkte, um ../
     * auszuschließen?
     */
