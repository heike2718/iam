...
public interface BaseDao {
     ...
     * @throws DuplicateEntityException  Die Message ist bei den bekannten
     *                                   UK-Constraints bereits menschenlesbar.
     *                                   Sonst generisch mit dem constraintName.
     * @throws ConcurrentUpdateException Die Message wird von der
     *                                   OptimisticLockException übernommen, muss
     *                                   also im Context noch sinnvoll übersetzt
     *                                   werden.
     * @throws AuthPersistenceException  in diesem Fall wurde die Exception bereits
     *                                   geloggt.
     */
     ...
     * <br>
     * <strong>Achtung: </strong> Der Aufrufer muss die Transaction markieren!!!! Es
     * wird nichts geloggt. Das sollte die aufrufende Klasse tun.
     *
     * @param <T>
     * @param entity
