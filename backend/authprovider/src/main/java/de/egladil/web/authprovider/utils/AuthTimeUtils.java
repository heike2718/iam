...
public final class AuthTimeUtils {
     ...
     * @return TimeInterval
     */
    public static TimeInterval getInterval(final LocalDateTime startTime, final int amount,
    ...
    public static String format(final LocalDateTime localDateTime) {
        ...
        return localDateTime == null ? null
                : localDateTime.format(DateTimeFormatter.ofPattern(DEFAULT_DATE_TIME_FORMAT));
    }
    ...
    public static String formatToMinutes(final LocalDateTime localDateTime) {
        ...
        return localDateTime == null ? null
                : localDateTime.format(DateTimeFormatter.ofPattern(DEFAULT_DATE_MINUTES_FORMAT));
    }
    ...
    /**
     * Wandelt einen String mit dem Format 'dd.MM.yyyy hh:mm:ss' in ein LocalDate
     * um.
     *
     * @param dateString darf nicht null sein. Muss gültiges Datumsformat haben.
     * @return LocalDate
