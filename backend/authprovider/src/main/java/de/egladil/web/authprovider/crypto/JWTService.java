...
public class JWTService {
    ...
    public JWTPayload createJWT(final ResourceOwner resourceOwner, final Client client) {
        ...
        TimeInterval jwtInterval = AuthTimeUtils
                .getInterval(AuthTimeUtils.now(), client.getJwtExpirationMinutes(), ChronoUnit.MINUTES);
    ...
    public JWTPayload createJWTWithEmail(final ResourceOwner resourceOwner, final Client client) {
        ...
        Builder builder = createMinimal(resourceOwner, jwtInterval)
                .withClaim(Claims.email.name(), resourceOwner.getEmail());
    ...
    private Builder createMinimal(final ResourceOwner resourceOwner, final TimeInterval jwtInterval) {
        ...
        return JWT
                .create()
                .withIssuer(ISSUER)
                .withIssuedAt(jwtInterval.getStartTime())
                .withExpiresAt(jwtInterval.getEndTime())
    ...
    private PrivateKey getPrivateKey() {
        ...
        try {
            ...
            throw new AuthCryptoException(
                    e.getClass().getSimpleName() + " beim Lesen des private keys: " + e.getMessage(), e);
        }
    }
}
