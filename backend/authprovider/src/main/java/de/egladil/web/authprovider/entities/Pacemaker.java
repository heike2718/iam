...
/**
 * Pacemaker (Herzschrittmacher) wird vom eigengebauten Monitor verwendet, um
 * regelmäßige Zugriffe auf die DB zu machen.
 */
@Entity
...
public class Pacemaker implements AuthProviderEntity {
    ...
    @Size(max = 50)
    /**
     * Die monitorId dient als fachlicher schlüssel für den einzigen Eintrag in der
     * Tabelle
     */
