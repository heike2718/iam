...
public interface AuthCryptoService {
    ...
    /**
     * @param password char[] der Aufrufer ist verantwortlich für das Löschen des
     *                 char[]
     * @return String
     */
    ...
    /**
     * Verwendet die pw- Einstellungen aus der crypto-Konfiguration, um einen
     * Zufallsstring zu generieren. Basiert auf SecureRandom.
     *
     * @return String
     */
