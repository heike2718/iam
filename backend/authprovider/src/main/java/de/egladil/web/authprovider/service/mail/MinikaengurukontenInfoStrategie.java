...
public class MinikaengurukontenInfoStrategie implements CreateDefaultMailDatenStrategy {
    ...
    private String getText() {
        ...
        String resourceOwnerDetails = StringUtils.abbreviate(resourceOwner.getUuid(), 11) + " - "
    ...
    public enum MinikaengurukontenMailKontext {
        CONFIRMATION_EXPIRED, LOGIN_INAKTIV, USER_CREATED, USER_CHANGED, SYNC_FAILED, BOT_ATTACK
