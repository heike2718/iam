...
/**
 * Ein Client ist eine Anwendung, die diesen AuthProvider für die
 * Authentisierung Ihrer Benutzer verwendet.<br>
 * <br>
 * <code>Beispiel:</code>die Minikänguru-Anwendung, die
 * Minikänguru-Admin-Anwendung, die Checklistenapp.
 */
@Entity
@Table(name = "CLIENTS")
public class Client implements AuthProviderEntity {
    ...
    @Size(max = 50)
    /**
     * Mit der clientId identifiziert sich die Client-Anwendung gegenüber dem
     * Identity-Provider
     */
