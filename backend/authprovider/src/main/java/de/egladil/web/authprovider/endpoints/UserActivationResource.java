...
/**
 * UserActivationResource stellt REST- Endpoints Aktivieren eines neu angelegten
 * ResourceOwner-Kontos zur Verfügung.
 */
@RequestScoped
...
public class UserActivationResource {
    ...
    @Parameters({ @Parameter(
            ...
            name = "code",
            description = "Ein beim Anlegen des Kontos generierter String, der miz der UUID persistiert ist und als Query-Parameter im Link mit der Mail versendet wird."), })
    public Response activateUser(@UuidString @QueryParam("code") final String confirmationCode) {
        ...
        try {
            ...
            LOG
                    .error("Unerwartete Exception beim Aktivieren des Benutzerkontos mit confirmationCode '"
        ...
        try {
            ...
            return Response
                    .serverError()
                    .entity("Leider ist ein Fehler aufgetreten. Bitte senden Sie eine Mail an "
