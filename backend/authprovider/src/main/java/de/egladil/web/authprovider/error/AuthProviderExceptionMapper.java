...
public class AuthProviderExceptionMapper implements ExceptionMapper<Exception> {
    ...
    public Response toResponse(final Exception exception) {
        ...
        String generalError = "Es ist ein Serverfehler aufgetreten. Bitte senden Sie eine Mail an "
                + monitoringMailEmpfaenger;
        ...
        if (exception instanceof SecurityException) {
            ...
            return Response
                    ...
                    .entity(ResponsePayload.messageOnly(MessagePayload.error("Netter Versuch, klappt aber nicht.")))
                    .build();
        }
        ...
        if (exception instanceof ClientAccessTokenRuntimeException) {
            ...
            if (ex.getClientCredentials() != null && ex.getClientCredentials().getRedirectUrl() != null) {
                ...
                LOGGER
                        .warn("Das client access token {} ist unterwegs verlorengegangen. redirectUrl={}",
                ...
                ResponsePayload payload = ResponsePayload
                        .messageOnly(MessagePayload.error("Fehler beim Holen der ClientDaten"));
                return Response.serverError().header("X-Auth-Error", "Serverfehler").entity(payload).build();
            }
        }

        if (exception instanceof AuthException || exception instanceof AuthRuntimeException) {
        ...
        if (exception instanceof InvalidRedirectUrl || exception instanceof AuthRuntimeException) {
            ...
            return Response
                    ...
                    .entity(ResponsePayload.messageOnly(MessagePayload.error(generalError)))
                    .build();
        }
    ...
    private Response handleDuplicateEntityException(final DuplicateEntityException e) {
        ...
        if (duplicateEntityType != null) {
            ...
            return Response
                    .status(duplicateEntityType.getDetailedStatuscode())
                    .entity(MessagePayload.warn(e.getMessage()))
                    .build();
        }

        return Response
                .status(e.getDefaultStatuscode())
