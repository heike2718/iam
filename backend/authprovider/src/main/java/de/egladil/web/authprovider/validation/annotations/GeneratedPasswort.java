...
/**
 * Genau 12 Zeichen, nur Großbuchstaben, Kleinbuchstaben und Ziffern 0-9, keine
 * Umlaute, kein ß.<br>
 * <br>
 * Wenn der Wert null ist, wird er als gültig angesehen. Es muss also zusätzlich
 * eine NotNull-Anntotation angebracht werden.
 */
@Documented
@Retention(RUNTIME)
