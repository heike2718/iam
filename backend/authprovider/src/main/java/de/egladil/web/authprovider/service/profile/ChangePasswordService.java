    ...
    public ResponsePayload changePassword(final String userUUID, final ProfilePasswordPayload payload) {
        ...
        try {
            ...
            if (!optResourceOwner.isPresent()) {
                ...
                LOG
                        .warn("An dieser Stelle müsste der ResourceOwner mit UUID {} vorhanden sein, weil das schon im AuthorizationFilter geprüft worden sein müsste",
                                userUUID);
            ...
            return ResponsePayload
                    .messageOnly(MessagePayload.info(applicationMessages.getString("Password.changed.success")));
