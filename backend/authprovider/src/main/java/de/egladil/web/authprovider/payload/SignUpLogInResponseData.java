...
/**
 * SignUpLogInResponseData enthalten die Daten, die nach einem SignUp oder einem
 * LogIn zurückgegebenn werden.
 * <ul>
 * <li><strong>state: </strong>Kontext zur Aktion, wird durch den Client erzeugt
 * und unverändert wieder zurückgegeben.</li>
