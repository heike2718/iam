...
public class TempPasswordMailService {
    ...
    public void versendeTempPasswordMail(final String email, final TempPassword tempPassword) {
        ...
        SendTempPasswordTask task = new SendTempPasswordTask(email, tempPassword, mailService,
                passwordConfig.getTempPwdUrl());
        ...
        try {
            ...
            throw new AuthRuntimeException(
                    "Senden der TempPassword-Mail konnte nicht beendet werden: " + e.getMessage(), e);
        }
    }
    ...
    private void persistSentStatusQuietly(final TempPassword tempPassword) {
        ...
        if (opt.isPresent()) {
            ...
            try {
                ...
                LOG
                        .warn("PersistenceException beim Speichern des Versendet-Status des {}. Wird ignoriert",
                                tempPassword);
            }
        }
    }
