...
public class AuthenticationResource {
    ...
    /**
     * Authentifiziert den Benutzer mit Loginname / Email und Passwort. Gibt als
     * SignUpLogInResponseData.idToken ein oneTimeToken zurück, mit dem der Server
     * des anfragenden Clients das JWT abholen kann.
     *
     * @param credentials
    ...
    @Parameters({ @Parameter(
            ...
            name = "accessToken",
            description = "Authentifiziert den Benutzer mit Loginname / Email und Passwort. Gibt als SignUpLogInResponseData.idToken ein oneTimeToken zurück, mit dem der Server des anfragenden Clients das JWT abholen kann."), })
    @APIResponse(
            name = "OKResponse",
            responseCode = "200",
            content = @Content(
