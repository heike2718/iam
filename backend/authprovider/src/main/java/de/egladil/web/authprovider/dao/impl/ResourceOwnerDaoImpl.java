...
public class ResourceOwnerDaoImpl extends BaseDaoImpl implements ResourceOwnerDao {
    ...
    public Optional<ResourceOwner> findByLoginName(final String loginName) {
        ...
        List<ResourceOwner> trefferliste = em
                .createNamedQuery(ResourceOwner.FIND_BY_LOGINNAME, ResourceOwner.class)
    ...
    public List<ResourceOwner> findByLoginnameLike(final String loginnameFragment) {
        ...
        return em
                .createNamedQuery(ResourceOwner.FIND_BY_LOGINNAME_LIKE, ResourceOwner.class)
    ...
    public Optional<ResourceOwner> findByEmail(final String email) {
        ...
        List<ResourceOwner> trefferliste = em
                .createNamedQuery(ResourceOwner.FIND_BY_EMAIL, ResourceOwner.class)
    ...
    public Optional<ResourceOwner> findByUUID(final String uuid) {
        ...
        List<ResourceOwner> trefferliste = em
                .createNamedQuery(ResourceOwner.FIND_BY_UUID, ResourceOwner.class)
    ...
    public List<ResourceOwner> findByEmailLike(final String emailfragment) {
        ...
        return em
                .createNamedQuery(ResourceOwner.FIND_BY_EMAIL_LIKE, ResourceOwner.class)
    ...
    public List<ResourceOwner> findByUuidLike(final String uuidFragment) {
        ...
        return em
                .createNamedQuery(ResourceOwner.FIND_BY_UUID_LIKE, ResourceOwner.class)
    ...
    public List<ResourceOwner> findOtherUsersWithSameEmail(final String email, final String uuidOwner) {
        ...
        List<ResourceOwner> resultList = em
                .createNamedQuery(ResourceOwner.FIND_OTHER_BY_EMAIL, ResourceOwner.class)
                .setParameter("uuid", uuidOwner)
                .setParameter("email", email.toLowerCase())
                .getResultList();
    ...
    public List<ResourceOwner> findUsersWithActivationAndBannedState(boolean activated, boolean bannedForMails) {
        return em
                .createNamedQuery(ResourceOwner.FIND_BY_ACTIVATION_AND_BANNED_STATE, ResourceOwner.class)
                .setParameter("aktiviert", activated)
                .setParameter("bannedForMails", bannedForMails)
                .getResultList();
    }
}
