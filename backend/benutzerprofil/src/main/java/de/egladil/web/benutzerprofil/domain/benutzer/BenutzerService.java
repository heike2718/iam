...
public class BenutzerService {
    ...
    public BenutzerDto ladeBenuterDaten() {
        ...
        try (Response response = authproviderRestClient.getUserProfile(selectPayload);) {
            ...
            LOGGER
                    .error("kein OK vom authprovider: USER {} existiert nicht mehr? Oder stimmt path beim AuthprovderRestClient.getUserProfile nicht?",
            ...
            if (!expectedNonce.equals(nonce)) {
                ...
                LOGGER
                        .warn(LogmessagePrefixes.BOT
                                + "angefragter Endpoint hat das nonce geändert: expected={}, actual={}", expectedNonce,
                                nonce);
