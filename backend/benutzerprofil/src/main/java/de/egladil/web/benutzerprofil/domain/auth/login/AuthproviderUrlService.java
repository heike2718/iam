...
import de.egladil.web.benutzerprofil.domain.auth.clientauth.ClientAccessTokenService;
...
public class AuthproviderUrlService {
	...
	public Response getSignupUrl() {
		...
		String redirectUrl = authAppUrl + "#/signup?accessToken=" + accessToken + "&state=signup&redirectUrl=" + publicRedirectUrl;
