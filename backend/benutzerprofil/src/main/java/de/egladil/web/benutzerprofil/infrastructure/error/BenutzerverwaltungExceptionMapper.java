    ...
    public Response toResponse(final Throwable exception) {
        ...
        if (exception instanceof WebApplicationException) {
            ...
            if (ex.getResponse().getStatus() == 403) {
                ...
                LOGGER
                        .warn("403: koennte auch eine fehlende mod-security-Konfiguration sein, wenn es ein PUT oder DELETE-Request war");
        ...
        if (exception instanceof DuplicateEntityException) {
            ...
            if (duplicateAttributeType != null) {
                ...
                return Response
                        .status(dee.getDefaultStatuscode())
                        .entity(MessagePayload
                                .warn(applicationMessages
                                        .getString(duplicateAttributeType.getApplicationMessagesKey())))
                        .build();
            }

            return Response
                    .status(dee.getDefaultStatuscode())
                    .entity(MessagePayload.warn(exception.getMessage()))
                    .build();
        }
        ...
        if (exception instanceof ConcurrentModificationException) {
            ...
            return Response
                    .status(((ConcurrentModificationException) exception).getDefaultStatuscode())
                    .entity(MessagePayload.warn(exception.getMessage()))
                    .build();
        }
