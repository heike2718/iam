...
import { DeleteMailversandauftragResponseDto, MailversandauftragDetails, MailversandauftragDetailsResponseDto, MailversandauftragOverview, Mailversandgruppe, MailversandgruppeDetails, MailversandgruppeDetailsResponseDto } from '@bv-admin/versandauftraege/model';
import { Benutzer, MailversandauftragRequestDto } from "@bv-admin/shared/model";
