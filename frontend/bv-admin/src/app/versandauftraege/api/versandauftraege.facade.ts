...
import { MailversandauftragDetails, MailversandauftragOverview, MailversandauftragUIModel, Mailversandgruppe, MailversandgruppeDetails } from '@bv-admin/versandauftraege/model';
import { select, Store } from "@ngrx/store";
import { fromVersandauftraege, versandauftraegeActions } from '@bv-admin/versandauftraege/data';
import { MailversandauftragRequestDto, Infomail, Benutzer } from "@bv-admin/shared/model";
...
export class VersandauftraegeFacade {
    ...
    readonly selectedVersandauftrag$: Observable<MailversandauftragUIModel | undefined> =
    ...
    public cancelVersandauftrag(uuid: string): void {

        this.#store.dispatch(versandauftraegeActions.cANCEL_VERSANDAUFTRAG({uuid}));
    }

    public continueVersandauftrag(uuid: string): void {

        this.#store.dispatch(versandauftraegeActions.cONTINUE_VERSANDAUFTRAG({uuid}));
    }
