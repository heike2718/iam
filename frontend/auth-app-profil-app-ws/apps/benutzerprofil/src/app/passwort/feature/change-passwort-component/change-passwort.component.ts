...
import { PasswortFacade } from '../../api/passwort.facade';
import { Subscription } from 'rxjs';

@Component({
    selector: 'app-benutzerprofil-passwort',
...
export class ChangePasswortComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        const passwortSubscription = this.passwortFacade.passwort$.subscribe(
            passwort => (this.#passwort = { ...passwort })
        );
