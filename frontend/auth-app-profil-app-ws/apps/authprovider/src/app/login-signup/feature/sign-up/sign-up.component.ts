...
import { NAME_REGELN, REG_EXP_INPUT_SECURED, REG_EXP_LOGIN_NAME, SIGNUP_SUCCESS_DIALOG_TEXT, trimFormValues } from "@ap-ws/common-utils";
import { LoginSignupFacade } from "@authprovider/login-signup/api";
import { SignUpFormModel, SignUpCredentials } from "@authprovider/login-signup/model";
import { ClientCredentials, ClientInformation } from "@authprovider/model";
